...
public class CheckInWidgetSmallProvider : AppWidgetProvider
{
    ...
    private const string ActionAutoRefresh = "com.companyname.sportrecordapp.AUTO_REFRESH_SMALL";
    ...
    private void StartAutoRefresh(Context context)
    {
        ...
        {
            var intent = new Intent(context, typeof(CheckInWidgetSmallProvider));
    ...
    public override void OnReceive(Context? context, Intent? intent)
    {
        ...
        else if (intent.Action == ActionAutoRefresh)
        {
            ...
            if (appWidgetManager != null)
            {
                var componentName = new ComponentName(context, Java.Lang.Class.FromType(typeof(CheckInWidgetSmallProvider)));
